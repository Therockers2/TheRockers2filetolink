# Don't Remove Credit @TheRockers2

# Ask Doubt on telegram @TheRockers2
...
# Bot information
SESSION = environ.get('SESSION', 'TheRockers2filetolink')
...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/TheRockers2")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002202878622'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '-1002111150515').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002188014900').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002111150515') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002188014900')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://therockers868:therockers866@cluster0.rozyzt7.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "therockers868")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'throckers868collection')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'rockdmbot) # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+9q1PuoSP790yZmVl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TheRockers2')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/TheRockers2')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'vO0e5kif06Mo9HGfPjerM4x7x8J2')
